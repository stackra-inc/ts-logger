...
export class ExpressAdapter extends AbstractHttpAdapter<http.Server | https.Server> {
  ...
  private onResponseHook?: (req: express.Request, res: express.Response) => Promise<void> | void;
  ...
  public setOnResponseHook(
    onResponseHook: (req: express.Request, res: express.Response) => Promise<void> | void
  ) {
  ...
  public reply(response: any, body: any, statusCode?: number) {
    ...
    if (body instanceof StreamableFile) {
      ...
      return stream.pipe<Writable>(response).on('error', (err: Error) => body.errorLogger(err));
    }
  ...
  public useBodyParser<Options extends NestExpressBodyParserOptions = NestExpressBodyParserOptions>(
  ...
  private isMiddlewareApplied(name: string): boolean {
    ...
    return (
      ...
      app.router.stack.some((layer: any) => layer && layer.handle && layer.handle.name === name)
    );
  }

  private setHeaderIfNotExists(response: any, name: string, value?: string | string[] | number) {
