import { FileTypeValidator, FileTypeValidatorOptions } from './file-type.validator';
import { FileValidator } from './file-validator.interface';
import { MaxFileSizeValidator, MaxFileSizeValidatorOptions } from './max-file-size.validator';
