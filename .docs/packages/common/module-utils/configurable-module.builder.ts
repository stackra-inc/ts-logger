  ...
  > {
    ...
    class InternalModuleClass {
      ...
      private static extractExtrasFromAsyncOptions(
        input: ConfigurableModuleAsyncOptions<ModuleOptions> & ExtraModuleDefinitionOptions,
        extras: ExtraModuleDefinitionOptions | undefined
      ...
      private static createAsyncOptionsProvider(
        ...
        return {
          provide: self.options.optionsInjectionToken!,
          useFactory: async (
            optionsFactory: ConfigurableModuleOptionsFactory<ModuleOptions, FactoryClassMethodKey>
