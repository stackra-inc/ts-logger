import { isNil, isNumber, isObject, isSymbol } from '@nestjs/common/utils/shared.utils';
...
export function GrpcMethod(service: string | undefined, method?: string): MethodDecorator {
  return (target: object, key: string | symbol, descriptor: PropertyDescriptor) => {
 ...
 */
export function GrpcStreamMethod(service: string, method?: string): MethodDecorator;
export function GrpcStreamMethod(service: string | undefined, method?: string): MethodDecorator {
  return (target: object, key: string | symbol, descriptor: PropertyDescriptor) => {
 ...
 * @param method Optional string parameter reflecting the name of method inside of a service definition coming after rpc keyword
 */
export function GrpcStreamCall(service: string, method?: string): MethodDecorator;
export function GrpcStreamCall(service: string | undefined, method?: string): MethodDecorator {
  return (target: object, key: string | symbol, descriptor: PropertyDescriptor) => {
    const metadata = createGrpcMethodMetadata(
      target,
      key,
