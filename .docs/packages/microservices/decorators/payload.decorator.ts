 ...
 * @publicApi
 */
export function Payload(...pipes: (Type<PipeTransform> | PipeTransform)[]): ParameterDecorator;
/**
...
export function Payload(
  ...
  return createPipesRpcParamDecorator(RpcParamtype.PAYLOAD)(propertyOrPipe, ...pipes);
}
