  ...
  implements INestMicroservice
{
  ...
  private microserviceConfig: Exclude<CompleteMicroserviceOptions, AsyncMicroserviceOptions>;
  ...
  public createServer(config: CompleteMicroserviceOptions) {
    try {
      ...
      this.serverInstance = ServerFactory.create(this.microserviceConfig) as Server;
    } catch (e) {
      this.logger.error(e);
      throw e;
    }
