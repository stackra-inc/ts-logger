...
describe('ClientMqtt', () => {
  ...
  describe('publish', () => {
    ...
    describe('dispose callback', () => {
      ...
      beforeEach(async () => {
        ...
        getResponsePatternStub = sinon.stub(client, 'getResponsePattern').callsFake(() => channel);
    ...
    describe('headers', () => {
      ...
      it('should send packet headers', async () => {
        ...
        client['publish'](msg, () => {});
        expect(publishSpy.getCall(0).args[2].properties.userProperties).to.eql(requestHeaders);
      });
  ...
  describe('connect', () => {
    ...
    beforeEach(async () => {
      ...
      mergeCloseEvent = sinon.stub(client, 'mergeCloseEvent').callsFake((_, source) => source);
    });
    afterEach(() => {
  ...
  describe('dispatchEvent', () => {
    ...
    describe('headers', () => {
      ...
      it('should send packet headers', async () => {
        ...
        await client['dispatchEvent'](msg);
        expect(publishStub.getCall(0).args[2].properties.userProperties).to.eql(requestHeaders);
      });
      it('should combine packet and static headers', async () => {
        publishStub.callsFake((a, b, c, d) => d());
        const staticHeaders = { 'client-id': 'some-client-id' };
