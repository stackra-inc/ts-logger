...
describe('ClientGrpcProxy', () => {
  ...
  describe('getService', () => {
    describe('when "grpcClient[name]" is nil', () => {
      ...
      it('should throw "InvalidGrpcServiceException" (multiple proto)', () => {
        ...
        expect(() => clientMulti.getService('test')).to.throw(InvalidGrpcServiceException);

        expect(() => clientMulti.getService('test2')).to.throw(InvalidGrpcServiceException);
      });
    });
    describe('when "grpcClient[name]" is not nil', () => {
      ...
      describe('when "grpcClient[name]" is not nil (multiple proto)', () => {
        it('should create grpcService', () => {
          ...
          expect(() => clientMulti.getService('test')).to.not.throw(InvalidGrpcServiceException);
          expect(() => clientMulti.getService('test2')).to.not.throw(InvalidGrpcServiceException);
        });
      });
    });
  });
  ...
  describe('createStreamServiceMethod', () => {
    it('should return observable', () => {
      ...
      const fn = client.createStreamServiceMethod({ [methodKey]: {} }, methodKey);
  ...
  describe('createUnaryServiceMethod', () => {
    it('should return observable', () => {
      const methodKey = 'method';
      const fn = client.createUnaryServiceMethod({ [methodKey]: {} }, methodKey);
      expect(fn()).to.be.instanceof(Observable);
    });
    describe('on subscribe', () => {
      const methodName = 'm';
  ...
  describe('dispatchEvent', () => {
    it('should throw exception', () => {
      client['dispatchEvent'](null).catch((error) => expect(error).to.be.instanceof(Error));
    });
  });
