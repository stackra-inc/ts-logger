  ...
  public static create(
    ...
    switch (transport) {
      case Transport.REDIS:
        return new ClientRedis(options as Required<RedisOptions>['options']) as ClientProxy;
      case Transport.NATS:
        return new ClientNats(options as Required<NatsOptions>['options']) as ClientProxy;
      case Transport.MQTT:
        return new ClientMqtt(options as Required<MqttOptions>['options']) as ClientProxy;
      case Transport.GRPC:
        return new ClientGrpcProxy(options as GrpcOptions['options']);
      case Transport.RMQ:
        return new ClientRMQ(options as Required<RmqOptions>['options']) as ClientProxy;
      case Transport.KAFKA:
        return new ClientKafka(options as Required<KafkaOptions>['options']);
      default:
        return new ClientTCP(options as Required<TcpClientOptions>['options']) as ClientProxy;
    }
  }
