 ...
 * @publicApi
 */
export class ClientGrpcProxy extends ClientProxy<never, never> implements ClientGrpc {
  ...
  public getKeepaliveOptions() {
    ...
    const keepaliveKeys: Record<keyof NonNullable<GrpcOptions['options']['keepalive']>, string> = {
