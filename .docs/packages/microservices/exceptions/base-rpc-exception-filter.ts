import { ArgumentsHost, IntrinsicException, Logger, RpcExceptionFilter } from '@nestjs/common';
 ...
 * @publicApi
 */
export class BaseRpcExceptionFilter<T = any, R = any> implements RpcExceptionFilter<T> {
