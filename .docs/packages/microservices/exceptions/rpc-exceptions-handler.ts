...
export class RpcExceptionsHandler extends BaseRpcExceptionFilter {
  ...
  public handle(exception: Error | RpcException, host: ArgumentsHost): Observable<any> {
  ...
  public invokeCustomFilters<T = any>(exception: T, host: ArgumentsHost): Observable<any> | null {
