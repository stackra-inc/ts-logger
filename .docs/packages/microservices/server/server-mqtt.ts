...
import { IncomingRequest, MessageHandler, PacketId, ReadPacket } from '../interfaces';
...
export class ServerMqtt extends Server<MqttEvents, MqttStatus> {
  ...
  public async handleMessage(
    ...
    const publish = this.getPublisher(pub, mqttContext, (packet as IncomingRequest).id);
  ...
  public getPublisher(client: MqttClient, context: MqttContext, id: string): any {
    return (response: any) => {
