...
export class ServerGrpc extends Server<never, never> {
   ...
   */
  private writeObservableToGrpc<T>(source: Observable<T>, call: GrpcCall<T>): Promise<void> {
  ...
  public createRequestStreamMethod(methodHandler: Function, isResponseStream: boolean) {
    return async (call: GrpcCall, callback: (err: unknown, value: unknown) => void) => {
      return this.onProcessingStartHook(
        this.transportId,
        { ...call, operationId: methodHandler.name } as any,
        async () => {
  ...
  public createStreamCallMethod(methodHandler: Function, isResponseStream: boolean) {
    return async (call: GrpcCall, callback: (err: unknown, value: unknown) => void) => {
      return this.onProcessingStartHook(
        this.transportId,
        { ...call, operationId: methodHandler.name } as any,
  ...
  public async createClient() {
    ...
    await new Promise((resolve, reject) => {
      server.bindAsync(
        ...
        (error: Error | null, port: number) => (error ? reject(error) : resolve(port))
      );
    });
