...
export class NestFactoryStatic {
  ...
  public async createMicroservice<T extends object>(
    ...
    return this.createNestInstance<INestMicroservice>(
      new NestMicroservice(container, options, graphInspector, applicationConfig)
    );
  }
  ...
  private registerLoggerConfiguration(options: NestApplicationContextOptions | undefined) {
    if (!options) {
      return;
    }
