...
import { HOST_METADATA, MODULE_PATH, VERSION_METADATA } from '@nestjs/common/constants';
import { Controller, HttpServer, Type, VersionValue } from '@nestjs/common/interfaces';
...
export class RoutesResolver implements Resolver {
  ...
  private isHttpFastifyError(error: any): error is Error & { statusCode: number } {
