...
export class DebugReplFn extends ReplFunction {
  ...
  private printCtrlsAndProviders(moduleName: string, moduleDebugEntry: ModuleDebugEntry) {
  ...
  private printCollection(title: string, collectionValue: Record<string, InjectionToken>) {
