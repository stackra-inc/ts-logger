    ...
    describe('otherwise', () => {
      describe('when route is not excluded', () => {
        it('should return false', () => {
          ...
          expect(routePathFactory.isExcludedFromGlobalPrefix('/cats', RequestMethod.GET)).to.be
            .false;
        });
      });
      describe('when route is excluded (by path)', () => {
        ...
        describe('when route is excluded (by method and path)', () => {
          it('should return true', () => {
            ...
            expect(routePathFactory.isExcludedFromGlobalPrefix('/cats', RequestMethod.GET)).to.be
              .true;
            expect(routePathFactory.isExcludedFromGlobalPrefix('/cats', RequestMethod.POST)).to.be
              .false;
          });
        });
      });
