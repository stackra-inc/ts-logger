...
describe('DependenciesScanner', () => {
  ...
  it('should "insertExportedProviderOrModule" call once (1 component) container method "addExportedProviderOrModule"', async () => {
    const expectation = mockContainer.expects('addExportedProviderOrModule').once();
    await scanner.scan(TestModule);
    expectation.verify();
  });
  ...
  describe('addScopedEnhancersMetadata', () => {
    ...
    it('should add enhancers metadata to every controller and every entry provider', () => {
      ...
      const addEnhancerMetadataControllerSpy = sinon.spy(fakeController, 'addEnhancerMetadata');
  ...
  describe('getApplyProvidersMap', () => {
    describe(`when token is ${APP_INTERCEPTOR}`, () => {
      it('call "addGlobalInterceptor"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalInterceptor');
    ...
    describe(`when token is ${APP_GUARD}`, () => {
      it('call "addGlobalGuard"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalGuard');
    ...
    describe(`when token is ${APP_PIPE}`, () => {
      it('call "addGlobalPipe"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalPipe');
    ...
    describe(`when token is ${APP_FILTER}`, () => {
      it('call "addGlobalFilter"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalFilter');
  ...
  describe('getApplyRequestProvidersMap', () => {
    describe(`when token is ${APP_INTERCEPTOR}`, () => {
      it('call "addGlobalRequestInterceptor"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalRequestInterceptor');
    ...
    describe(`when token is ${APP_GUARD}`, () => {
      it('call "addGlobalRequestGuard"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalRequestGuard');
    ...
    describe(`when token is ${APP_PIPE}`, () => {
      it('call "addGlobalRequestPipe"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalRequestPipe');
    ...
    describe(`when token is ${APP_FILTER}`, () => {
      it('call "addGlobalRequestFilter"', () => {
        const addSpy = sinon.spy(untypedScanner.applicationConfig, 'addGlobalRequestFilter');
