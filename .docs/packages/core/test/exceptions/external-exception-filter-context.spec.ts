...
describe('ExternalExceptionFilterContext', () => {
  ...
  beforeEach(() => {
    ...
    exceptionFilter = new ExternalExceptionFilterContext(new NestContainer(), applicationConfig);
  });
  describe('create', () => {
    describe('when filters metadata is empty', () => {
      ...
      it('should return plain ExceptionHandler object', () => {
        const filter = exceptionFilter.create(new EmptyMetadata(), () => ({}) as any, undefined!);
    ...
    describe('when filters metadata is not empty', () => {
      ...
      it('should return ExceptionHandler object with exception filters', () => {
        const filter = exceptionFilter.create(new WithMetadata(), () => ({}) as any, undefined!);
  ...
  describe('reflectCatchExceptions', () => {
    it('should return FILTER_CATCH_EXCEPTIONS metadata', () => {
      expect(exceptionFilter.reflectCatchExceptions(new ExceptionFilter())).to.be.eql([
        CustomException,
      ]);
    });
    it('should return an empty array when metadata was found', () => {
      expect(exceptionFilter.reflectCatchExceptions(new ClassWithNoMetadata())).to.be.eql([]);
    });
  });
