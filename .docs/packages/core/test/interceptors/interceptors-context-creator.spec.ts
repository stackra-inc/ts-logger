...
describe('InterceptorsContextCreator', () => {
  ...
  beforeEach(() => {
    ...
    interceptorsContextCreator = new InterceptorsContextCreator(container, applicationConfig);
  });
  ...
  describe('getInterceptorInstance', () => {
    describe('when param is an object', () => {
      it('should return instance', () => {
        ...
        expect(interceptorsContextCreator.getInterceptorInstance(instance)).to.be.eql(instance);
      });
    });
    describe('when param is a constructor', () => {
      it('should pick instance from container', () => {
        ...
        expect(interceptorsContextCreator.getInterceptorInstance(Interceptor)).to.be.eql(
          wrapper.instance
        );
      });
      it('should return null', () => {
        sinon.stub(interceptorsContextCreator, 'getInstanceByMetatype').callsFake(() => null!);
  ...
  describe('getInstanceByMetatype', () => {
    describe('when "moduleContext" is nil', () => {
      it('should return undefined', () => {
        ...
        expect(interceptorsContextCreator.getInstanceByMetatype(null!)).to.be.undefined;
      });
    });
  ...
  describe('getGlobalMetadata', () => {
    ...
    describe('otherwise', () => {
      it('should merge static global with request/transient scoped interceptors', () => {
        ...
        expect(interceptorsContextCreator.getGlobalMetadata({ id: 3 })).to.contains(
          instance,
          ...globalInterceptors
        );
      });
