...
describe('DiscoveryService', () => {
  ...
  describe('createDecorator', () => {
    ...
    it('should create a decorator that can decorate methods', () => {
      ...
      const metadata = Reflect.getMetadata(TestDecorator.KEY, new TestClass().handleClick);
    ...
    it('should add class to DiscoverableMetaHostCollection when decorating a class', () => {
      ...
      expect(addClassMetaHostLinkSpy.calledWith(TestClass, TestDecorator.KEY)).to.be.true;
    });
  ...
  describe('getProviders', () => {
    ...
    it('should filter providers by metadataKey when provided', () => {
      ...
      expect(getProvidersByMetaKeyStub.calledWith(modulesContainer, metadataKey)).to.be.true;
    ...
    it('should return empty array when no providers match the metadataKey', () => {
      ...
      sandbox.stub(DiscoverableMetaHostCollection, 'getProvidersByMetaKey').returns(emptySet);
  ...
  describe('getControllers', () => {
    ...
    it('should filter controllers by metadataKey when provided', () => {
      ...
      expect(getControllersByMetaKeyStub.calledWith(modulesContainer, metadataKey)).to.be.true;
  ...
  describe('getMetadataByDecorator', () => {
    it('should retrieve metadata from class using decorator', () => {
      ...
      const metadata = discoveryService.getMetadataByDecorator(TestDecorator, wrapper);
    ...
    it('should retrieve metadata from method using decorator and methodKey', () => {
      ...
      const metadata = discoveryService.getMetadataByDecorator(TestDecorator, wrapper, 'onCreate');
