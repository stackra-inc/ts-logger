...
describe('Module', () => {
  ...
  describe('when exported provider is custom provided', () => {
    ...
    it('should call `addCustomExportedProvider`', () => {
      const addCustomExportedProviderSpy = sinon.spy(moduleRef, 'addCustomExportedProvider');
  ...
  describe('replace', () => {
    ...
    describe('when guard', () => {
      it('should call `mergeWith`', () => {
        ...
        sinon.stub(moduleRef.injectables, 'get').callsFake(() => wrapper as any);
  ...
  describe('createModuleReferenceType', () => {
    ...
    describe('get', () => {
      it('should throw exception if not exists', () => {
        expect(() => customModuleRef.get('fail')).to.throws(UnknownElementException);
      });
    });
  });
  describe('validateExportedProvider', () => {
    ...
    describe('when unit exists in related modules collection', () => {
      it('should behave as identity', () => {
        class Random {}
        untypedModuleRef._imports = new Set([new Module(Random, new NestContainer())]);
    ...
    describe('when unit does not exist in both provider and related modules collections', () => {
      it('should throw UnknownExportException', () => {
        expect(() => moduleRef.validateExportedProvider(token)).to.throws(UnknownExportException);
      });
    });
  });
