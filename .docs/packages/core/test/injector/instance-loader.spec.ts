...
describe('InstanceLoader', () => {
  ...
  it('should call "loadPrototype" for every provider and controller in every module', async () => {
    ...
    expect(loadProviderPrototypeStub.calledWith(ctrlWrapper, moduleMock.controllers)).to.be.true;
  });
  ...
  describe('for every provider in every module', () => {
    ...
    it('should call "loadProvider"', async () => {
      expect(
        loadProviderStub.calledWith(moduleMock.providers.get(testProviderToken), moduleMock as any)
      ).to.be.true;
    });
  ...
  describe('for every controller in every module', () => {
    ...
    it('should call "loadController"', async () => {
      expect(
        loadControllerStub.calledWith(moduleMock.controllers.get('TestRoute'), moduleMock as any)
      ).to.be.true;
    });
    it('should call "inspectInstanceWrapper"', async () => {
      expect(
  ...
  describe('for every injectable in every module', () => {
    ...
    it('should call "loadInjectable"', async () => {
      expect(
        loadInjectableStub.calledWith(moduleMock.injectables.get('TestProvider'), moduleMock as any)
      ).to.be.true;
    });
    it('should call "inspectInstanceWrapper"', async () => {
      expect(
