  ...
  describe('removeInstanceByContextId', () => {
    ...
    describe('when transient and inquirer has been passed', () => {
      it('should remove instance for given context', () => {
        ...
        const existingContext = wrapper.getInstanceByContextId(STATIC_CONTEXT, 'inquirerId');
        expect(existingContext.instance).to.be.not.undefined;
        wrapper.removeInstanceByContextId(STATIC_CONTEXT, 'inquirerId');

        const removedContext = wrapper.getInstanceByContextId(STATIC_CONTEXT, 'inquirerId');
        expect(removedContext.instance).to.be.undefined;
      });
    });
  });
    ...
    describe('when instance is transient', () => {
      ...
      describe('lifecycle hooks on transient services', () => {
        ...
        it('should filter out instances created with Object.create (prototype only)', () => {
          ...
          wrapper.setInstanceByInquirerId(STATIC_CONTEXT, 'inquirer', prototypeOnlyInstance);
        ...
        it('should include instances where constructor was actually invoked', () => {
          ...
          wrapper.setInstanceByInquirerId(STATIC_CONTEXT, 'inquirer', properInstance);

          // Should include this instance for lifecycle hooks
          expect(wrapper.getStaticTransientInstances()).to.be.eql([properInstance]);
        });
      });
    });
  });
