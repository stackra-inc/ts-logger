...
export class ModuleCompiler {
  constructor(private readonly _moduleOpaqueKeyFactory: ModuleOpaqueKeyFactory) {}
  ...
  public async compile(
    moduleClsOrDynamic: Type | DynamicModule | ForwardReference | Promise<DynamicModule>
    ...
    const token = dynamicMetadata
      ...
      : this._moduleOpaqueKeyFactory.createForStatic(type, moduleClsOrDynamic as Type);

    return { type, dynamicMetadata, token };
  }

  public extractMetadata(moduleClsOrDynamic: Type | ForwardReference | DynamicModule): {
    type: Type;
