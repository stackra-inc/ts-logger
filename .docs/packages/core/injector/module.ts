import { EnhancerSubtype, ENTRY_PROVIDER_WATERMARK } from '@nestjs/common/constants';
import {
  ClassProvider,
  Controller,
  DynamicModule,
...
export class Module {
  ...
  public addProvider(provider: Provider, enhancerSubtype?: EnhancerSubtype) {
    ...
    if (
      (this.isTransientProvider(provider) || this.isRequestScopeProvider(provider)) &&
      isAlreadyDeclared
    ) {
      return provider;
    }
  ...
  public getControllerById<T = any>(id: string): InstanceWrapper<T> | undefined {
