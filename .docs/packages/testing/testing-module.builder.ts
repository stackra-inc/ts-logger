...
import { MockFactory, OverrideBy, OverrideByFactoryOptions } from './interfaces';
...
export class TestingModuleBuilder {
  ...
  public async compile(
    ...
    return new TestingModule(this.container, graphInspector, root, this.applicationConfig);
  }
