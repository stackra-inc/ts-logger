...
import { AbstractHttpAdapter, NestApplication, NestApplicationContext } from '@nestjs/core';
...
export class TestingModule extends NestApplicationContext {
  ...
  private isHttpServer(
    serverOrOptions: HttpServer | AbstractHttpAdapter | NestApplicationOptions | undefined
  ...
  public createNestMicroservice<T extends object>(
    ...
    const { NestMicroservice } = loadPackage('@nestjs/microservices', 'TestingModule', () =>
