...
describe('SocketServerProvider', () => {
  ...
  beforeEach(() => {
    ...
    instance = new SocketServerProvider(socketsContainer, new ApplicationConfig(new NoopAdapter()));
  });
  describe('scanForSocketServer', () => {
    ...
    it(`should call "decorateWithNamespace" when namespace is specified`, () => {
      const decorateWithNamespaceSpy = sinon.spy(instance, 'decorateWithNamespace' as any);
